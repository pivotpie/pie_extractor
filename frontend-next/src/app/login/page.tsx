...
import { Brain, FileText, Zap, Shield, Github, Star, TrendingUp, Users, Loader2 } from "lucide-react";
              ...
              <CardContent className="space-y-6">
                ...
                <div className="text-center">
                  <div className="text-sm text-muted-foreground">
                    ...
                    <button type="button" className="text-primary hover:underline font-medium" onClick={() => router.push('/register')}>
                      Sign up for free
                    </button>
                  </div>
                </div>
